...
- One-off explorations are extra `/levels/<lab>-<slug>` routes under **Experiments**, not new flags on canonical pages.

## Canonical routes

- `/levels` — Level Types (four labs) + empty Experiments
- `/levels/aichatlab`, `/levels/aichatlab-setup`, `/levels/aichatlab-model-card`
- `/levels/weblab2-level`, `/levels/weblab2-demo-project`, `/levels/weblab2-demo-project-blank`
