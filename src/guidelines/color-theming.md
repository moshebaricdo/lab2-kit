...
The Lab2 kit uses packaged CADS from public npm:
...
Installed as `@moshebari/cads-react` / `@moshebari/cads-variables` `^0.2.0`. Catalog: **`/design-system/cads`**. Do not add new `App*` usage on Lab2 surfaces.
