...
6. **Checklist `Dropdown` `menuWidth`** — CADS forces checklist menus to hug content, so `menuWidth="trigger"` is ignored. Prefer a hug menu, or wait for CADS to honor the prop.
